...
(library Library_1
	...
	(compDef "MAX5523EUA+" (originalName "MAX5523EUA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "REFOUT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "OUTA") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "OUTB") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://pdfserv.maximintegrated.com/en/ds/MAX5522-MAX5525.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "MAX5523EUA+.stp")
